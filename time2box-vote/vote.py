...
class VoteInfoHandler(tornado.web.RequestHandler):
    def get(self):
        ...
        _vote_id=self.get_argument("id", "11111", True)
    ...
    def post(self):
        ...
        _id=self.get_argument("id", "11111", True)
        logging.info("id: ", _id)
        print(_id)
        #_idx = (self.request.arguments['idx'])[0]
        _idx=self.get_argument("idx", "11111", True)
        print(_idx)
